...
const components = [
  ...
  },
  {
    ...
    description: 'All assets are produced by the STIK MΛGIC bot pipeline — this site presents, previews, and serves them.'
  }
];
    ...
    <div className="space-y-8 pb-10">
      <Panel>
        ...
        <h1 className="mt-5 text-4xl font-semibold tracking-tight text-text sm:text-5xl">
          The STIK MΛGIC ecosystem.
        </h1>
        <p className="mt-4 max-w-3xl text-base leading-relaxed text-muted">
          STIK MΛGIC is a modular visual system with a clean split between asset generation and presentation. The bot
      ...
      <Panel variant="secondary">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted">
          ...
          browser, live mockup generator, and account / download library — all powered by the STIK MΛGIC bot pipeline as
          a backend API.
        </p>
      </Panel>
    </div>
