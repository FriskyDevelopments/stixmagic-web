...
const steps: GeneratorStep[] = [
  ...
  },
  {
    ...
    label: 'Choose Style',
    description:
      'Select from available STIXMΛGIC style presets — neon, motion, minimal, retro, and more. Each style maps to a motion preset in the pipeline.',
    comingSoon: true
  },
  {
    id: 'preview-output',
    ...
    <div className="space-y-8 pb-10">
      <Panel>
        ...
        <p className="mt-4 max-w-3xl text-base leading-relaxed text-muted">
          The STIXMΛGIC generator frontend is being scaffolded here. When the bot pipeline exposes a generation API,
      ...
      <Panel variant="secondary">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted">
          The generator UI will consume a generation API exposed by the STIXMΛGIC bot pipeline. No asset generation
