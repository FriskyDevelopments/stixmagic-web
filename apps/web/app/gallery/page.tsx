...
const filterTabs = [
  {
    id: 'all',
    label: 'All Assets',
    content: 'All STIK MΛGIC preview assets across packs and categories. GIF and WebM previews where available.'
  },
  {
    id: 'animated',
    label: 'Animated',
    ...
    <div className="space-y-8 pb-10">
      <Panel>
        ...
        <p className="mt-4 max-w-3xl text-base leading-relaxed text-muted">
          Browse individual STIK MΛGIC assets with GIF and WebM previews, format tags, and pack metadata. All assets are
          generated by the STIK MΛGIC pipeline.
        </p>
      </Panel>
      ...
      <Panel variant="secondary">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted">
          Preview assets are loaded from the STIK MΛGIC pipeline manifest. As the bot pipeline generates new assets, they
