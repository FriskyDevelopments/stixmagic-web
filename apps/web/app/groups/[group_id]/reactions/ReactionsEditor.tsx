...
const RESPONSE_HINT: Partial<Record<ResponseType, string>> = {
  sticker:
    'To get a sticker file ID: forward the sticker to @userinfobot or use the /sticker command with your STIKMΛGIC bot.',
  animation:
    'To get a GIF file ID: send the animation in a chat with your STIKMΛGIC bot, which will reply with the file ID.'
};
          ...
          >
              ...
              {form.triggerType === 'emoji' ? (
                ...
                <>
                  ...
                  <p className="mt-1.5 text-xs text-muted">
                    💡 To find a sticker&apos;s file ID: forward the sticker to your STIKMΛGIC bot
            ...
            <div className="flex gap-3 pt-2">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-accent-primary px-5 py-2 text-sm font-semibold text-white transition hover:bg-accent-indigo focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary/50 disabled:cursor-not-allowed disabled:opacity-40"
              >
                {saving && (
                  <svg
