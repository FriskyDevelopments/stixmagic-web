...
const RESPONSE_HINT: Partial<Record<ResponseType, string>> = {
  sticker:
    'To get a sticker file ID: forward the sticker to @userinfobot or use the /sticker command with your STIXMΛGIC bot.',
  animation:
    'To get a GIF file ID: send the animation in a chat with your STIXMΛGIC bot, which will reply with the file ID.'
};
              ...
              {form.triggerType === 'emoji' ? (
                ...
                <>
                  ...
                  <p className="mt-1.5 text-xs text-muted">
                    💡 To find a sticker&apos;s file ID: forward the sticker to your STIXMΛGIC bot
