  ...
  return (
    <div className="space-y-8 pb-10">
      <Panel>
        ...
        <h1 className="mt-3 text-3xl font-semibold text-text">STIXMΛGIC Telegram Control Center</h1>
          ...
          <Panel variant="secondary">
            <div className="py-6 text-center">
              ...
              <p className="mt-1 text-sm text-muted">
                Add the STIXMΛGIC bot to your Telegram group and give it admin rights to see it here.
              </p>
            </div>
          </Panel>
        ) : (
